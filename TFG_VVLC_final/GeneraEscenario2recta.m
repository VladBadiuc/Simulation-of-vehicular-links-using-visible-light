function [DaTX,DaRX]=GeneraEscenario2recta(d,D,par,MatPot,parVehiculo1,parVehiculo2)
...
alpha=asin(D/d);
r2=[d*cos(alpha) D Hf];    % COCHE_2 SEGUIDOR
...
% TX: pilotos traseros "TailLignt TL"
% Right
TLr0=[Lvl/2 DBl/2+i*sH HBl+sV*y];
...
xHLl1=r1+xHLl0;
% Right
HLr2=r2+xHLr1;                      % desplazamiento
% Left
HLl2=r2+xHLl1;                      % desplazamiento
